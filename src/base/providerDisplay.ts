...
const BUILTIN_PROVIDERS: Record<string, ProviderDisplay> = {
    ...
    youtubeMusic: { label: "YT Music", acronym: "YT MUSIC", color: "#ff0033", colorSubtle: "#7a1500", colorBright: "#ff4040" },
    musicBrainz: { label: "MusicBrainz", acronym: "MB", color: "#741b81", colorSubtle: "#6b1060", colorBright: "#ba47b5" },
    deezer: { label: "Deezer", acronym: "DEEZER", color: "#9546f7", colorSubtle: "#005570", colorBright: "#00c7f2" },
    appleMusic: { label: "Apple Music", acronym: "APPLE", color: "#fb233b", colorSubtle: "#505050", colorBright: "#cccccc" },
    ...
    soundcloud: { label: "SoundCloud", acronym: "SOUNDCLOUD", color: "#ff5510", colorSubtle: "#7a2500", colorBright: "#ff5500" },
    bandcamp: { label: "Bandcamp", acronym: "BANDCAMP", color: "#3b8db2", colorSubtle: "#0a5060", colorBright: "#1da0c3" },
    ytdlp: { label: "YtDlp", acronym: "YTDLP", color: "#ff0033", colorSubtle: "#7a1500", colorBright: "#ff4040" },
    soulseek: { label: "Soulseek", acronym: "SOULSEEK", color: "#2700ff", colorSubtle: "#100080", colorBright: "#4040ff" },
};

const FALLBACK: ProviderDisplay = { label: "", acronym: "", color: "white", colorSubtle: "#404040", colorBright: "#aaaaaa" };
