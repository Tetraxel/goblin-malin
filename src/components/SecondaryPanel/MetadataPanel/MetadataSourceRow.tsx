...
function confidenceBadge(
    ...
    if (confidence === undefined) return { text: "[??%]", color: theme.text.secondary };
...
export const MetadataSourceRow: React.FC<SourceRowProps> = ({ source, isSelected, isActive, width }) => {
    ...
    return (
        ...
        >
            ...
            <Box width={badge.text.length + 1} minWidth={badge.text.length + 1} paddingRight={1} flexShrink={0}>
                <Text color={badge.color} dimColor={isDimmed} strikethrough={isDimmed} wrap="truncate-end">
                    {badge.text}
                </Text>
            </Box>
            <Box
            ...
            >
                {prefixParts.map((part, i) => (
                    ...
                    >
                        ...
                        <Text color={prefixColor} dimColor={isDimmed} strikethrough={isDimmed} wrap="truncate-end">
                            {part}
                        </Text>
                    </Box>
                ))}
